...
PKG_NAME=launchdarkly_flag_eval
REV:=$(shell git rev-parse HEAD | cut -c1-6)
LDFLAGS:=-ldflags="-X main.version=$(REV) -X github.com/angelolapus/terraform-provider-launchdarkly-flag-evaluation/launchdarkly.version=$(REV)"
